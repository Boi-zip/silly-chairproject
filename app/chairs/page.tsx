  ...
  return (
    <div>
       <Navbar/>
        ...
        <SellingItem text="Couchy chair" price="160" desc="A 1 seat couch to keep you comfortable"
        ...
        <div className="sellingitems">
          <SellingItem text="Relaxing chair" price="75" desc="Fancy chair that will look good in your office"
        ...
        <SellingItem text="Wood chair" price="30" desc="Small childrens chair that is reasonably priced"
        ...
        <div className="sellingitems">
          <SellingItem text="TABLEEE" price="10000" desc="Our only premium, small table"
        ...
        <div className="sellingitems">
          <SellingItem text="Premium Gaming chair" price="320" desc="Gaming chair designed for gaming marathons"
        ...
        <SellingItem text="Therapy chair" price="520" desc="A long chair that looks like a bed to think in"
        ...
        <div className="sellingitems">
          <SellingItem text="Gaming chair" price="240" desc="A normal E-sports gaming chair"
        ...
        <SellingItem text="Skeleton chair" price="420" desc="Chair straight from a museum"
        img="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%2Fid%2FOIP.Z5yLLW-ritzZNymPKZ1PbgHaHP%3Fpid%3DApi&f=1&ipt=97a275a90d90e16cc68d56494752cbd09bf0612249a5a0c17cf879ca9905a813&ipo=images" additem={addToCart}/>
         ...
         <div className="sellingitems">
          <SellingItem text="Plastic chair" price="20" desc="Even cheaper plastic chair, our cheapest item"
        ...
        <SellingItem text="Premium chair" price="670" desc="A chair that will make you look like a king"
